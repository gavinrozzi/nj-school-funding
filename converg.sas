		...
		%if (&cv)=1 %then
			%DO;
				...
				data line;
					...
					label cycl='Cycle' nit='Iteration' targ='Target' tot='EQA' datd2='Error' 
						f18amult='W. mult.' f18bmult='I. mult.';
					FORmat targ tot comma16. datd2 comma14. cycl nit 2. f18amult f18bmult 
						12.10;
					cycl=&cyc;
					nit=&it;
					tot=&total;
			...
			%else
				...
				data line;
					keep cycl nit targ tot datd2 f18amult f18bmult;
					label cycl='Cycle' nit='Iteration' targ='Target' tot='EQA_FEQA' 
						datd2='Error' f18amult='W. mult.' f18bmult='I. mult.';
					format targ tot comma16. datd2 comma14. cycl nit 2. f18amult f18bmult 
						12.10;
					cycl=&cyc;
					nit=&it;
